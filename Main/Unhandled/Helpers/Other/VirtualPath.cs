...
namespace System.Web {
    ...
    #pragma warning restore 0649
            ...
            get {
                if (_virtualPath == null) {
                    ...
                    if (HttpRuntime.AppDomainAppVirtualPath == null) {
                        throw new HttpException("SR.GetString(SR.VirtualPath_CantMakeAppAbsolute, _appRelativeVirtualPath)"); // todo
                    }
        ...
        internal string AppRelativeVirtualPathStringOrNull {
            get {
                if (_appRelativeVirtualPath == null) {
                    ...
                    // This is not valid if we don't know the app path
                    if (HttpRuntime.AppDomainAppVirtualPath == null) {
                        throw new HttpException("SR.GetString(SR.VirtualPath_CantMakeAppRelative, _virtualPath)");  // todo
                    }
        ...
        //    return HttpRuntime.AppDomainAppVirtualPath.Combine(this);
        //}
        ...
        public string MapPath() {
            return HostingEnvironment.MapPath(this.AppRelativeVirtualPathString); //todo
        }
        ...
        public string GetFileHash(IEnumerable virtualPathDependencies) {
            return HostingEnvironment.VirtualPathProvider.GetFileHash(this.AppRelativeVirtualPathString, virtualPathDependencies);
        }
        ...
        public bool FileExists() {
            return HostingEnvironment.VirtualPathProvider.FileExists(this.FileName);
        }

        public bool DirectoryExists() {
            return HostingEnvironment.VirtualPathProvider.DirectoryExists(this.FileName); //todo:wtf?
        }

        //public VirtualFile GetFile() {
        //    return HostingEnvironment.VirtualPathProvider.GetFile(this.Ge);
        //}
            ...
            get {
                ...
                if (!flags[isWithinAppRootComputed]) {
                    ...
                    if (flags[appRelativeAttempted]) {
                        ...
                        flags[isWithinAppRoot] = UrlPath.IsEqualOrSubpath(HttpRuntime.AppDomainAppVirtualPath,
                            VirtualPathString);
                    }
        ...
        internal void FailIfNotWithinAppRoot() {
            if (!this.IsWithinAppRoot) {
                throw new ArgumentException("SR.GetString(SR.Cross_app_not_allowed, this.VirtualPathString)");  // todo
            }
        }

        internal void FailIfRelativePath() {
            if (this.IsRelative) {
                throw new ArgumentException("SR.GetString(SR.VirtualPath_AllowRelativePath, _virtualPath)");  // todo
            }
        }
        ...
        internal static VirtualPath Combine(VirtualPath v1, VirtualPath v2) {
            ...
            if (v1 == null) {
                v1 = Create(HttpRuntime.AppDomainAppVirtualPath); //todo
            }
        ...
        public override String ToString() {
            ...
            if (_virtualPath == null && HttpRuntime.AppDomainAppVirtualPath == null)
            {
                Debug.Assert(_appRelativeVirtualPath != null);
                return _appRelativeVirtualPath;
            }
        ...
        public static VirtualPath Create(string virtualPath, VirtualPathOptions options) {
            ...
            //todo check if i need this code
            //unsafe {
            ...
            //                // invalid chars
            //                case '\0':
            //                    throw new HttpException("SR.GetString(SR.Invalid_vpath, virtualPath)"); // todo
            //                default:
            //                    break;
            //            }
            //        }
            ...
            if (UrlPath.IsAppRelativePath(virtualPath)) {
                ...
                if (virtualPath[0] == UrlPath.appRelativeCharacter) {
                    if ((options & VirtualPathOptions.AllowAppRelativePath) == 0) {
                        throw new ArgumentException("SR.GetString(SR.VirtualPath_AllowAppRelativePath, virtualPath)"); // todo
                    }
                    ...
                    if ((options & VirtualPathOptions.AllowAbsolutePath) == 0) {
                        throw new ArgumentException("SR.GetString(SR.VirtualPath_AllowAbsolutePath, virtualPath)"); // todo
                    }
                ...
                if (virtualPath[0] != '/') {
                    if ((options & VirtualPathOptions.AllowRelativePath) == 0) {
                        throw new ArgumentException("SR.GetString(SR.VirtualPath_AllowRelativePath, virtualPath)"); // todo
                    }
